...
/* curl_strequal() and curl_strnequal() are subject for removal in a future
   release */
typedef int (__cdecl *curl_strequal)(const char *s1, const char *s2);
typedef int (__cdecl *curl_strnequal)(const char *s1, const char *s2, size_t n);
 ...
 * target handle.
 */
typedef curl_mime *(__cdecl *curl_mime_init)(CURL *easy);
 ...
 */
typedef void (__cdecl *curl_mime_free)(curl_mime *mime);
 ...
 * the created part.
 */
typedef curl_mimepart *(__cdecl *curl_mime_addpart)(curl_mime *mime);
 ...
 */
typedef CURLcode (__cdecl *curl_mime_name)(curl_mimepart *part, const char *name);
 ...
 */
typedef CURLcode (__cdecl *curl_mime_filename)(curl_mimepart *part,
                                        const char *filename);
 ...
 * Set mime part type.
 */
typedef CURLcode (__cdecl *curl_mime_type)(curl_mimepart *part, const char *mimetype);
 ...
 */
typedef CURLcode (__cdecl *curl_mime_encoder)(curl_mimepart *part,
                                       const char *encoding);
 ...
 */
typedef CURLcode (__cdecl *curl_mime_data)(curl_mimepart *part,
 ...
 */
typedef CURLcode (__cdecl *curl_mime_filedata)(curl_mimepart *part,
                                        const char *filename);
 ...
 */
typedef CURLcode (__cdecl *curl_mime_data_cb)(curl_mimepart *part,
                                       curl_off_t datasize,
 ...
 */
typedef CURLcode (__cdecl *curl_mime_subparts)(curl_mimepart *part,
                                        curl_mime *subparts);
/*
 ...
 */
typedef CURLcode (__cdecl *curl_mime_headers)(curl_mimepart *part,
 ...
 */
typedef CURLFORMcode (__cdecl *curl_formadd)(struct curl_httppost **httppost,
 ...
 */
typedef int (__cdecl *curl_formget)(struct curl_httppost *form, void *arg,
 ...
 */
typedef void (__cdecl *curl_formfree)(struct curl_httppost *form);
 ...
 */
typedef char *(__cdecl *curl_getenv)(const char *variable);
 ...
 */
typedef char *(__cdecl *curl_version)(void);
 ...
 * error occurred.
 */
typedef char *(__cdecl *curl_easy_escape)(CURL *handle,
                                   const char *string,
                                   int length);

/* the previous version: */
typedef char *(__cdecl *curl_escape)(const char *string,
                              int length);
 ...
 */
typedef char *(__cdecl *curl_easy_unescape)(CURL *handle,
                                     const char *string,
                                     int length,
                                     int *outlength);

/* the previous version */
typedef char *(__cdecl *curl_unescape)(const char *string,
                                int length);
 ...
 */
typedef void (__cdecl *curl_free)(void *p);
 ...
 */
typedef CURLcode (__cdecl *curl_global_init)(long flags);
 ...
 */
typedef CURLcode (__cdecl *curl_global_init_mem)(long flags,
 ...
 * that uses libcurl
 */
typedef void (__cdecl *curl_global_cleanup)(void);
...
typedef CURLsslset (__cdecl *curl_global_sslset)(curl_sslbackend id, const char *name,
 ...
 */
typedef struct curl_slist *(__cdecl *curl_slist_append)(struct curl_slist *,
                                                 const char *);
 ...
 */
typedef void (__cdecl *curl_slist_free_all)(struct curl_slist *);
 ...
 */
typedef time_t (__cdecl *curl_getdate)(const char *p, const time_t *unused);
...
typedef CURLSH *(__cdecl *curl_share_init)(void);
typedef CURLSHcode (__cdecl *curl_share_setopt)(CURLSH *, CURLSHoption option, ...);
typedef CURLSHcode (__cdecl *curl_share_cleanup)(CURLSH *);
 ...
 * struct. See above.
 */
typedef curl_version_info_data *(__cdecl *curl_version_info)(CURLversion);
 ...
 */
typedef const char *(__cdecl *curl_easy_strerror)(CURLcode);
 ...
 * for printing meaningful error messages.
 */
typedef const char *(__cdecl *curl_share_strerror)(CURLSHcode);
 ...
 *
 */
typedef CURLcode (__cdecl *curl_easy_pause)(CURL *handle, int bitmask);
